...
def save_extracted_dataset(cfg, dataset_embedding, dataset_label, dataset_idx, save_cnt):
    ...
    save_path = cfg.save_path + f"embedded_{cfg.dataset_type}_{cfg.embedding_model.split('/')[-1]}_{cfg.crop}_{save_cnt}.pt"
...
class Preprocess:
    ...
    def preprocess_rare_pattern(self):
        ...
        if cfg.feature_type == 'embedding':
            ...
            data_path = lambda x: cfg.save_path + f"embedded_{cfg.dataset_type}_{cfg.embedding_model.split('/')[-1]}_{cfg.crop}_{x}.pt"
